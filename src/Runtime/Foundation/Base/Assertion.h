...
//@―---------------------------------------------------------------------------
#define OB_REQUIRE_EX(expr,format,...)				OB_ASSERT_BASE(expr,ob::ELogType::Fatal,format,__VA_ARGS__)
...
//@―---------------------------------------------------------------------------
#define OB_ENSURE_EX(expr,format,...)				OB_ASSERT_BASE(expr,ob::ELogType::Warning,format,__VA_ARGS__)

...
namespace ob {
    ...
    public:
        ...
        //! @brief 視錐台からビュー行列の生成
        //@―---------------------------------------------------------------------------
        static Matrix Frustum(f32 left, f32 right, f32 bottom, f32 top, f32 zNear, f32 zFar);
        ...
        //! @brief  平行投影行列の生成
        //@―---------------------------------------------------------------------------
        static Matrix Ortho(f32 left, f32 right, f32 bottom, f32 top, f32 zNear, f32 zFar);

...
namespace ob {
    ...
    public:
        ...
        //  コンストラクタ / デストラクタ
        //===============================================================
        Rect() noexcept;                                                    // デフォルトコンストラクタ
        Rect(EForceInit) noexcept;                                          // コンストラクタ(サイズ / 中心指定)
        Rect(const Vec2& center, const Vec2& size = Vec2::zero) noexcept;   // コンストラクタ(引数指定)
        Rect(const Vec2* points, size_t count) noexcept;                    // コンストラクタ(点群指定)


        //===============================================================
        //  オペレータ
        //===============================================================
        bool    operator==(const Rect& other)const noexcept;                // 比較演算子
        Rect    operator+(const Vec2& point)const noexcept;                 // 加算演算子(合成)
        Rect& operator+=(const Vec2& point) noexcept;                       // 加算代入演算子(合成)
        ...
        void SetStartEnd(const Vec2& start, const Vec2& end) noexcept;      // 2点を指定して Rect を設定


        //===============================================================
        //  ゲッター
        //===============================================================
        Vec2 GetStart()const noexcept;                                      // ボックスの起点となる頂点を取得
        Vec2 GetEnd()const noexcept;                                        // GetStart() と対角となる頂点を取得


        //===============================================================
        //  判定
        //===============================================================
        bool IsEmpty()const noexcept;                                       // サイズが0以下であるか


    public:

        static Rect Create(const Vec2& start, const Vec2& end) noexcept;    // 2点を指定して Box を作成する

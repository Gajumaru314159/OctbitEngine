...
namespace ob {
    namespace platform {
        ...
        const TCHAR* WindowImpl::WINDOW_CLASS_NAME = __TEXT("OctbitWindow");
        const TCHAR* WindowImpl::PROPERTY_NAME = __TEXT("OctbitWindowProp");
        ...
        WindowImpl::WindowImpl(const WindowCreationDesc& desc)
            :m_className(fmt::format(__TEXT("{}_{}"), WINDOW_CLASS_NAME, m_windowNum))
        {
            m_hWnd = nullptr;

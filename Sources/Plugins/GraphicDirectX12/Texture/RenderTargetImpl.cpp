...
namespace ob::graphic::dx12 {
        ...
        : m_desc(desc)
    {
        ...
        // RTVディスクリプタを生成
        rDevice.allocateHandle(graphic::DescriptorHeapType::RTV, m_hRTV, targetNum);

        // 深度ビューのデスクリプタヒープ作成
        rDevice.allocateHandle(graphic::DescriptorHeapType::DSV, m_hDSV, 1);

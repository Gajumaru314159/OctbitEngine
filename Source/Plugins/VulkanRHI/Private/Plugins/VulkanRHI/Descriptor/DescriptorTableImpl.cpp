...
namespace ob::rhi::vulkan
{
	...
	DescriptorTableImpl::DescriptorTableImpl(VulkanRHI& rhi, const Ref<RootSignature>& signature, s32 slot)
		: m_rhi(rhi)
	...
	DescriptorTableImpl::DescriptorTableImpl(VulkanRHI& rhi, const BindingSlot& desc)
		: m_rhi(rhi)
		, m_desc(desc)
	{
	...
	bool DescriptorTableImpl::tryGetRangeType(s32 index, const Ref<rhi::Buffer>& buffer, vk::DescriptorType& type) const {
	...
	bool DescriptorTableImpl::tryGetRangeType(s32 index, const Ref<rhi::Texture>& texture, vk::DescriptorType& type) const {
	...
	bool DescriptorTableImpl::tryGetRangeType(s32 index, const Ref<rhi::Sampler>& sampler, vk::DescriptorType& type) const {

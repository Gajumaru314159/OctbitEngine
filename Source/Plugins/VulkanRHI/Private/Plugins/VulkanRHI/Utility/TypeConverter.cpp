...
namespace ob::rhi::vulkan
{
	...
	//@―---------------------------------------------------------------------------
	VkFormat TypeConverter::Convert(TextureFormat value) {
		switch (value) {
		...
		case TextureFormat::RG32:           return VK_FORMAT_R32G32_SFLOAT;
		case TextureFormat::RG16:           return VK_FORMAT_R16G16_SFLOAT;
		case TextureFormat::RG8:            return VK_FORMAT_R8G8_UNORM;

		case TextureFormat::R32:            return VK_FORMAT_R32_SFLOAT;
		...
		case TextureFormat::D16:            return VK_FORMAT_D16_UNORM;

...
//===============================================================
//! @cond
template <> struct fmt::formatter<ob::core::IPAddress, ob::core::Char> : fmt::formatter<ob::core::f32, ob::core::Char> {
	using base = fmt::formatter<ob::core::u8, ob::core::Char>;
	template<typename FormatContext>
	auto format(const ob::core::IPAddress& value, FormatContext& ctx) -> decltype(ctx.out()) {

...
//===============================================================
//! @cond
template <> struct fmt::formatter<ob::core::IntVec3, ob::core::Char> : fmt::formatter<ob::core::s32, ob::core::Char> {
    using base = fmt::formatter<ob::core::s32, ob::core::Char>;
    template<typename FormatContext>
    auto format(const ob::core::IntVec3& value, FormatContext& ctx) -> decltype(ctx.out()) {

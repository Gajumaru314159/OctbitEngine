...
//===============================================================
//! @cond
template <> struct std::formatter<ob::core::IntVec2, ob::core::Char> : std::formatter<ob::core::s32, ob::core::Char> {
    using base = std::formatter<ob::core::s32, ob::core::Char>;
    template<typename FormatContext>
    auto format(const ob::core::IntVec2& value, FormatContext& ctx)  const -> decltype(ctx.out()) {

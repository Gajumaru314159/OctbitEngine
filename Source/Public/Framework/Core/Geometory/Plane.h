...
namespace ob::core {
    ...
    public:
        ...
        //@―---------------------------------------------------------------------------
        constexpr Plane(const Vec3& normal, f32 distance);
    ...
    //! @brief コンストラクタ(法線と原点からの距離で初期化)
    //@―---------------------------------------------------------------------------
    constexpr Plane::Plane(const Vec3& normal, f32 distance) 
    ...
    //! @brief コンストラクタ(平面上の1点と法線で初期化)
    //@―---------------------------------------------------------------------------
    inline Plane::Plane(const Vec3& base, const Vec3& _normal) {
        normal = _normal;
        normal.normalize();
